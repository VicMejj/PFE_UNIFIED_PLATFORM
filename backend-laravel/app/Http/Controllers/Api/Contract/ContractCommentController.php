...
class ContractCommentController extends ApiController
{
    ...
    protected $modelClass = \App\Models\Contract\ContractComment::class;
    ...
    protected function authorizeContractManagement()
    {
        ...
        return $this->forbiddenResponse('Only managers, HR, or administrators can manage contract comments.');
    }
