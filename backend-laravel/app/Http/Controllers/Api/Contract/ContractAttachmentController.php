...
class ContractAttachmentController extends ApiController
{
    ...
    protected $modelClass = \App\Models\Contract\ContractAttachment::class;
    ...
    protected function authorizeContractManagement()
    {
        ...
        return $this->forbiddenResponse('Only managers, HR, or administrators can manage contract attachments.');
    }
